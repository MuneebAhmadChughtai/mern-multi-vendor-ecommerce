        ...
        <div className='bg-[#6f68d1] p-4 rounded-md'>
          ...
          <form onSubmit={handleSubmit}>
            <div className='flex flex-col w-full gap-1 mb-3'>
              ...
              <input className='px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-md' onChange={handleInput} value={state.name} type="text" name='name' placeholder='Name' id='name' required />
            </div>
